...
class Ingredient(models.Model):
    ...
    weight = models.IntegerField(help_text='Average fruit piece in grams')
    teaspoon = models.IntegerField(help_text='Weight of teaspoon in grams',default=None,null=True,blank=True) 
    tablespoon = models.FloatField(help_text='Weight of tablespoon in grams',default=None,null=True,blank=True)
    cup = models.IntegerField(help_text='Weight ofcup in grams',default=None,null=True,blank=True)
