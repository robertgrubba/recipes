...
class Type(models.Model):
    ...
    slug = models.CharField(max_length=40,help_text='Slug for url', default=None,null=True,blank=True)
...
class Ingredient(models.Model):
    ...
    image_vertical = ResizedImageField(size=[624,416],quality=85,keep_meta=True,upload_to='images/%Y/%m/%d/',default=None,null=True,blank=True)
