...
import logging
logging.basicConfig(filename='calculator_error.log', level=logging.DEBUG,format='%(asctime)s %(levelname)s %(name)s %(message)s')
...
<<<<<<< HEAD
            if ingredient.measure == 'ts':
                if ingredient.product.calories: calories =calories + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.calories)
                if ingredient.product.teaspoon: weight = weight + (ingredient.amount * ingredient.product.teaspoon)
                if ingredient.product.carbohydrates: carbohydrates = carbohydrates + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.carbohydrates)
                if ingredient.product.water: water = water + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.water)
                if ingredient.product.sugar: sugar = sugar + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.sugar)
                if ingredient.product.dietaryfiber: fiber = fiber + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.dietaryfiber)
                if ingredient.product.fat: fat = fat + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.fat)
                if ingredient.product.protein: protein = protein + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.protein)
                if ingredient.product.vita: vita = vita + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vita)
                if ingredient.product.vita1: vita1 = vita1 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vita1)
                if ingredient.product.vitc: vitc = vitc + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitc)
                if ingredient.product.vitb1: vitb1 = vitb1 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb1)
                if ingredient.product.vitb2: vitb2 = vitb2 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb2)
                if ingredient.product.vitb3: vitb3 = vitb3 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb3)
                if ingredient.product.vitb5: vitb5 = vitb5 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb5)
                if ingredient.product.vitb6: vitb6 = vitb6 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb6)
                if ingredient.product.vitb9: vitb9 = vitb9 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb9)
                if ingredient.product.vitb12: vitb12 = vitb12 + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitb12)
                if ingredient.product.vite: vite = vite + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vite)
                if ingredient.product.vitk: vitk = vitk + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.vitk)
                if ingredient.product.calcium: calcium = calcium + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.calcium)
                if ingredient.product.copper: copper = copper + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.copper)
                if ingredient.product.iron: iron = iron + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.iron)
                if ingredient.product.magnesium: magnesium = magnesium + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.magnesium)
                if ingredient.product.manganese: manganese = manganese + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.manganese)
                if ingredient.product.phosphorous: phosphorous = phosphorous + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.phosphorous)
                if ingredient.product.potassium: potassium = potassium + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.potassium)
                if ingredient.product.selenium: selenium = selenium + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.selenium)
                if ingredient.product.sodium: sodium = sodium + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.sodium)
                if ingredient.product.zinc: zinc = zinc + ((ingredient.amount * ingredient.product.teaspoon)/100 * ingredient.product.zinc)

            if ingredient.measure == 'tb':
                if ingredient.product.calories: calories =calories + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.calories)
                if ingredient.product.tablespoon: weight = weight + (ingredient.amount * ingredient.product.tablespoon)
                if ingredient.product.carbohydrates: carbohydrates = carbohydrates + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.carbohydrates)
                if ingredient.product.water: water = water + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.water)
                if ingredient.product.sugar: sugar = sugar + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.sugar)
                if ingredient.product.dietaryfiber: fiber = fiber + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.dietaryfiber)
                if ingredient.product.fat: fat = fat + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.fat)
                if ingredient.product.protein: protein = protein + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.protein)
                if ingredient.product.vita: vita = vita + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vita)
                if ingredient.product.vita1: vita1 = vita1 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vita1)
                if ingredient.product.vitc: vitc = vitc + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitc)
                if ingredient.product.vitb1: vitb1 = vitb1 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb1)
                if ingredient.product.vitb2: vitb2 = vitb2 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb2)
                if ingredient.product.vitb3: vitb3 = vitb3 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb3)
                if ingredient.product.vitb5: vitb5 = vitb5 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb5)
                if ingredient.product.vitb6: vitb6 = vitb6 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb6)
                if ingredient.product.vitb9: vitb9 = vitb9 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb9)
                if ingredient.product.vitb12: vitb12 = vitb12 + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitb12)
                if ingredient.product.vite: vite = vite + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vite)
                if ingredient.product.vitk: vitk = vitk + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.vitk)
                if ingredient.product.calcium: calcium = calcium + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.calcium)
                if ingredient.product.copper: copper = copper + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.copper)
                if ingredient.product.iron: iron = iron + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.iron)
                if ingredient.product.magnesium: magnesium = magnesium + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.magnesium)
                if ingredient.product.manganese: manganese = manganese + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.manganese)
                if ingredient.product.phosphorous: phosphorous = phosphorous + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.phosphorous)
                if ingredient.product.potassium: potassium = potassium + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.potassium)
                if ingredient.product.selenium: selenium = selenium + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.selenium)
                if ingredient.product.sodium: sodium = sodium + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.sodium)
                if ingredient.product.zinc: zinc = zinc + ((ingredient.amount * ingredient.product.tablespoon)/100 * ingredient.product.zinc)
...
>>>>>>> calculator
                ...
                if ingredient.measure == 'g': 
                    ...
                    if ingredient.product.sodium: sodium = sodium + ((ingredient.amount )/100 * ingredient.product.sodium)
                    if ingredient.product.zinc: zinc = zinc + ((ingredient.amount )/100 * ingredient.product.zinc)
                if ingredient.measure == 'oz': 
                    if ingredient.product.calories: calories =calories + (((ingredient.amount )/100 * ingredient.product.calories)*28.35)
                    weight = weight + (ingredient.amount )*28.35
                    if ingredient.product.carbohydrates: carbohydrates = carbohydrates + ((ingredient.amount )/100 * ingredient.product.carbohydrates)*28.35
                    if ingredient.product.water: water = water + ((ingredient.amount )/100 * ingredient.product.water)*28.349
                    if ingredient.product.sugar: sugar = sugar + ((ingredient.amount )/100 * ingredient.product.sugar)*28.349
                    if ingredient.product.dietaryfiber: fiber = fiber + ((ingredient.amount )/100 * ingredient.product.dietaryfiber)*28.349
                    if ingredient.product.fat: fat = fat + ((ingredient.amount )/100 * ingredient.product.fat)*28.349
                    if ingredient.product.protein: protein = protein + ((ingredient.amount )/100 * ingredient.product.protein)*28.349
                    if ingredient.product.vita: vita = vita + ((ingredient.amount )/100 * ingredient.product.vita)*28.349
                    if ingredient.product.vita1: vita1 = vita1 + ((ingredient.amount )/100 * ingredient.product.vita1)*28.349
                    if ingredient.product.vitc: vitc = vitc + ((ingredient.amount )/100 * ingredient.product.vitc)*28.349
                    if ingredient.product.vitb1: vitb1 = vitb1 + ((ingredient.amount )/100 * ingredient.product.vitb1)*28.349
                    if ingredient.product.vitb2: vitb2 = vitb2 + ((ingredient.amount )/100 * ingredient.product.vitb2)*28.349
                    if ingredient.product.vitb3: vitb3 = vitb3 + ((ingredient.amount )/100 * ingredient.product.vitb3)*28.349
                    if ingredient.product.vitb5: vitb5 = vitb5 + ((ingredient.amount )/100 * ingredient.product.vitb5)*28.349
                    if ingredient.product.vitb6: vitb6 = vitb6 + ((ingredient.amount )/100 * ingredient.product.vitb6)*28.349
                    if ingredient.product.vitb9: vitb9 = vitb9 + ((ingredient.amount )/100 * ingredient.product.vitb9)*28.349
                    if ingredient.product.vitb12: vitb12 = vitb12 + ((ingredient.amount )/100 * ingredient.product.vitb12)*28.349
                    if ingredient.product.vite: vite = vite + ((ingredient.amount )/100 * ingredient.product.vite)*28.349
                    if ingredient.product.vitk: vitk = vitk + ((ingredient.amount )/100 * ingredient.product.vitk)*28.349
                    if ingredient.product.calcium: calcium = calcium + ((ingredient.amount )/100 * ingredient.product.calcium)*28.349
                    if ingredient.product.copper: copper = copper + ((ingredient.amount )/100 * ingredient.product.copper)*28.349
                    if ingredient.product.iron: iron = iron + ((ingredient.amount )/100 * ingredient.product.iron)*28.349
                    if ingredient.product.magnesium: magnesium = magnesium + ((ingredient.amount )/100 * ingredient.product.magnesium)*28.349
                    if ingredient.product.manganese: manganese = manganese + ((ingredient.amount )/100 * ingredient.product.manganese)*28.349
                    if ingredient.product.phosphorous: phosphorous = phosphorous + ((ingredient.amount )/100 * ingredient.product.phosphorous)*28.349
                    if ingredient.product.potassium: potassium = potassium + ((ingredient.amount )/100 * ingredient.product.potassium)*28.349
                    if ingredient.product.selenium: selenium = selenium + ((ingredient.amount )/100 * ingredient.product.selenium)*28.349
                    if ingredient.product.sodium: sodium = sodium + ((ingredient.amount )/100 * ingredient.product.sodium)*28.349
                    if ingredient.product.zinc: zinc = zinc + ((ingredient.amount )/100 * ingredient.product.zinc)*28.349
            except Exception as e:
                logger.error(e)
                logger.error("For ingredient: "+ingredient.product.name+" ID: "+str(ingredient.product.id))
                logger.error("Ingredient measure: "+ingredient.measure)
            finally:
                pass
