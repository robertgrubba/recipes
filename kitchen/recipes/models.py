...
class Recipe(models.Model):
    ...
    image = ResizedImageField(size=[500,300],quality=85,keep_meta=True,upload_to='images/%Y/%m/%d/',default=None,null=True,blank=True,help_text="major image of meal for detail page, vertical")
    thumbnail = ResizedImageField(size=[500,300],quality=85,keep_meta=True,upload_to='images/%Y/%m/%d/',default=None,null=True,blank=True,help_text="image for thumbnail on listings, horizontal")
